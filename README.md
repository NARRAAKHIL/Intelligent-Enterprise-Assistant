...
```
body {
    /* CHANGED: Swapped light blue to a light green */
    background: #eaffea; 
    text-align: center;
...
Navigate to the intelligent-enterprise-assistant-v2 directory.

Step 2: Install Dependencies
You need to install Flask (if not already) and the fuzzy matching library thefuzz.
...
python app.py
You will see output indicating the server is running, likely on:
...
# OUTPUT 
<img width="1915" height="1009" alt="image" src="https://github.com/user-attachments/assets/b3747ee5-72a0-4895-a7e8-37b8c8762102" />
